In this Markdown file, an analysis from different data collection (for Spotify) was copied separately and a new separate dataset (datase) was created here using this base.
